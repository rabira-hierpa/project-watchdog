    ...
    if (this.state.projects.length > 0) {
      allProjects = this.state.projects.map((project, index) => (
        ...
        <tr>
          ...
          <td> {project.Member.length }
          </td>
          <td> {new Date(project.DeadLine).toString().substr(0, 10) }
          </td>
          <td> {project.Progress + "%"} 
          </td>
          <td>
            <span>
              <a href="#!" type="button" id="editBtn" className="btn btn-sm btn-outline-danger btn-rounded" title="Block Project">
                ...
                <table className="table table-hover w-auto">
                    <thead className="blue darken-3 text-white">
                        <tr>
                            <th scope="col"> #No </th>
                            <th scope="col">
                                <i className="fa fa-list pr-2" aria-hidden="true" /> Title
                              </th>
                            <th scope="col">
                                <i className="fa fa-user-circle-o pr-2" aria-hidden="true" /> Members
                              </th>
                            <th scope="col">
                                <i className="fa fa-calendar pr-2" aria-hidden="true" /> Deadline
                              </th>
                            <th scope="col"> % Progress </th>
                            <th scope="col">
                                <i className="fa fa-edit pr-2" aria-hidden="true" /> Action
                              </th>
                          </tr>
                      </thead>
