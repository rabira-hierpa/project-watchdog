...
const Footer = () => {
    return (
        <footer
            className="page-footer center-on-small-only stylish-color-dark bg-indigo">
            <div className="container">
                <div className="row">
                    <div className="col-md-4">
                        <h5 className="title mb-4 mt-3 font-bold">Footer Content
                        </h5>
            ...
            <div className="call-to-action">
                <ul>
                    ...
                    <li>
                        <a  href="signup.html"
                            className="btn btn-rounded btn-red">
                            <i className="fa fa-sign-in fa-sm"></i>
                            Sign up!</a>
                    </li>
                </ul>
            </div>
            ...
            <div className="footer-copyright">
                <div className="container-fluid">
                    © 2018 Copyright:
                    <a href="https://www.projectwatchdog.com">
                        ProjectWatchdog
                    </a>
                </div>
            </div>
